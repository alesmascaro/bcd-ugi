...
This repository contains the `R` code to implement the methodology presented in the paper *Bayesian causal discovery from unknown general interventions*, which will be soon made available as an ArXiv. 

In particular, the script `learn_DTP.R` contains a function implementing Algorithm $5$ of the same paper. The sub-directory `Auxiliary functions` contains all the associated internal functions.
