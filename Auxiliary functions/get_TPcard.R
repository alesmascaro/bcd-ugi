get_TPcard <- function(k, currentDAG, currentTARGETS, currentkthPARENTS) {
  q <- ncol(currentDAG)
  modifiedDAG <- modify_parents(currentDAG, currentTARGETS[k,], currentkthPARENTS)
  AugmentedDAG <- get_augmentedDAG(modifiedDAG, currentTARGETS[k,], currentkthPARENTS)
